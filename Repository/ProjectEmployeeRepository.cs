...
namespace AngularAppApi.Repository
{
    public class ProjectEmployeeRepository : IProjectEmployeeRepository
    {
        ...
        IEnumerable<Employees> IProjectEmployeeRepository.GetAssingnedEmployees(int idProject)
        {
            throw new System.NotImplementedException();
        }

        IEnumerable<Employees> IProjectEmployeeRepository.GetAvailableEmployees(int idProject)
        {
            throw new System.NotImplementedException();
        }

        IEnumerable<Project_Employee> IProjectEmployeeRepository.GetProjectEmployees()
        {
            throw new System.NotImplementedException();
        }
    }
